...
export type SubscriptionFunction = (query: string, variables?: Record<string, any>) => void;
...
export const apiSubscription = (options: chainOptions) => (query: string, variables: Record<string, any> = {}) => {
  try {
...
export const Cast = {
  ...
  subscription: ((o: any) => (_: any) => o) as CastToGraphQL<ValueTypes['Subscription'], GraphQLTypes['Subscription']>,
};
