...
["CardStack"]: {
	...
	["Nameable"]: ModelTypes["CardStack"] | ModelTypes["SpecialCard"] | ModelTypes["EffectCard"] | ModelTypes["Card"];
	/** Aws S3 File */
["S3Object"]: {
		bucket:string,
	key:string,
...
["CardStack"]: {
	...
	["Nameable"]: {
	__typename:"CardStack" | "SpecialCard" | "EffectCard" | "Card",
	name: string
...
subscription: (o:ValueTypes["Subscription"], operationName?: string) => queryConstruct('subscription', 'Subscription', operationName)(o)
};
