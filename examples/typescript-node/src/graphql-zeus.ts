...
export type PartialObjects = {
  ...
  ['Nameable']: {
    ...
    | PartialObjects['Card']
    | PartialObjects['CardStack']
    | PartialObjects['EffectCard']
    | PartialObjects['SpecialCard']
  );
  ['Query']: {
    __typename?: 'Query';
...
type CastToGraphQL<V, T> = (resultOfYourQuery: any) => <Z>(o: Z | V) => MapType<T, Z>;
...
export const Chain = (...options: fetchOptions) => ({
  Query: ((o: any) => fullChainConstruct(options)('Query')(o).then((response: any) => response)) as OperationToGraphQL<
    ValueTypes['Query'],
    Query
  >,
  Mutation: ((o: any) =>
    fullChainConstruct(options)('Mutation')(o).then((response: any) => response)) as OperationToGraphQL<
    ValueTypes['Mutation'],
    Mutation
  >,
});
...
export const Cast = {
  ...
  Mutation: ((o: any) => (b: any) => o) as CastToGraphQL<ValueTypes['Mutation'], Mutation>,
};
