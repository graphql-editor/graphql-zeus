...
export const Thunder = (fn) => ({
  query: (o, variables) => fullChainConstruct(fn)('query', 'Query')(o, variables).then((response) => response),
  mutation: (o, variables) =>
    fullChainConstruct(fn)('mutation', 'NotMutation')(o, variables).then((response) => response),
  subscription: (o, variables) =>
    fullChainConstruct(fn)('subscription', 'NotSubscription')(o, variables).then((response) => response),
});

export const Chain = (options) => ({
  query: (o, variables) =>
    fullChainConstruct(apiFetch(options))('query', 'Query')(o, variables).then((response) => response),
  mutation: (o, variables) =>
    fullChainConstruct(apiFetch(options))('mutation', 'NotMutation')(o, variables).then((response) => response),
  subscription: (o, variables) =>
    fullChainConstruct(apiFetch(options))('subscription', 'NotSubscription')(o, variables).then((response) => response),
});
export const Zeus = {
