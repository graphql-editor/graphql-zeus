export default function Home() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-gradient-to-b from-zinc-900 to-zinc-800">
      <h1 className="text-5xl font-bold text-white mb-4">Zeus + Next.js</h1>
      ...
      <div className="mt-8 bg-zinc-950 rounded-lg p-4 font-mono text-sm text-zinc-300">
        <code>npx graphql-zeus {'<schema>'} ./lib --node</code>
      </div>
      <p className="mt-6 text-zinc-500 text-sm">
        Edit <code className="bg-zinc-800 px-1.5 py-0.5 rounded">app/page.tsx</code> to get started
      </p>
    </main>
  );
}
