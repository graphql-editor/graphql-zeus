...
function PostList() {
  const { data, isLoading } = useQuery({
    queryKey: ['posts'],
    queryFn: async () =>
      request('https://api.com/graphql', GET_POSTS, { limit: 10 }),
  });
...
- **[Apollo Client](/integrations/apollo-client)** - Complete Apollo integration
- **[React Query](/integrations/react-query)** - React Query patterns
- **[urql](/integrations/urql)** - urql integration guide

[Explore Apollo Client Integration →](/integrations/apollo-client)
